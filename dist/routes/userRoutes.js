...
import { user_get_sign_up, user_get_log_in, user_post_sign_up, user_get_join_us, user_put_join_us, user_get_my_account, user_put_admin, } from '../controllers/userController';
import { signUpValidation, joinUsValidation, validate, } from '../middleware/validator.js';
...
routes.post('/log-in', passport.authenticate('local', {
    successRedirect: '/',
